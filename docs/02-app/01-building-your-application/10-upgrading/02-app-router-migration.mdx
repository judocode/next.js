...
> **Warning:** The app router is still suffering from [memory](https://github.com/vercel/next.js/issues/54708) and [performance](https://github.com/vercel/next.js/issues/48748) issues that can, in some circumstances, use up large amounts of system memory and cause your app to load very slow or sometimes not load at all. Use with caution.
